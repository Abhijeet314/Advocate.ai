	...
	return (
		<footer 
			...
			<div className="flex flex-wrap justify-center md:justify-end md:gap-24 lg:gap-48">
                <Image src="/heropage.png" alt="chatbot" width={200} height={100} />
				<div className='basis-1/2 md:basis-0'>
					...
					<div style={space.style} className="flex flex-col text-base mt-2">
						...
						<a className="my-1" href="#tracks">Features</a>
						<a className="my-1" href="#timeline">Pricing</a>
						<a className="my-1" href="#organizers">Adovcates</a>
						<a className="my-1" href="#sponsors">Learning</a>
				...
				<div className='my-4 md:my-0'>
					...
					<p style={space.style} className="text-base my-2">Legal Help for Lawyers</p>
					<div className="flex justify-center gap-2">
						<a href="https://www.instagram.com/gdg_rbu/" target="_blank" rel="noopener noreferrer">
							<Image style={{ height: 40, width: 'auto' }} src='/insta.svg' width={40} height={40} alt='Instagram' />
						</a>
						<a href="https://x.com/gdsc_rcoem" target="_blank" rel="noopener noreferrer">
							<Image style={{ height: 40, width: 'auto' }} src='/twitter.svg' width={40} height={40} alt='Twitter' />
						</a>
						<a href="https://www.linkedin.com/company/gdsc-rcoem/" target="_blank" rel="noopener noreferrer">
							<Image style={{ height: 40, width: 'auto' }} src='/linkdin.svg' width={40} height={40} alt='LinkedIn' />
						</a>
					</div>
				</div>
			</div>
